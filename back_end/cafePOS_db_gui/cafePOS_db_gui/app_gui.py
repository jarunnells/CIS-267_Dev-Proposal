...
db.insert_record("CB001", "bev_cold", "Aquafina", "AQUA H20", 1.09)
db.insert_record("DE001", "deli", "Noodle Cup", "NOODLE CUP", 1.25)
db.insert_record("SN001", "snack", "House Cookie", "HOUSE COOKIE", 1.64)
db.insert_record("CD001", "condiment", "Dressing", "DRESSING", 0.75)
db.insert_record("BK002", "bkfast", "Muffin", "MUFFIN", 2.75)
db.insert_record("HB002", "bev_hot", "Coffee", "COFFEE", 1.99)
db.insert_record("CB002", "bev_cold", "Aquafina", "AQUA H20", 1.25)
db.insert_record("DE002", "deli", "Noodle Cup", "NOODLE CUP", 1.29)
db.insert_record("SN002", "snack", "House Cookie", "HOUSE COOKIE", 1.64)
db.insert_record("CD002", "condiment", "Dressing", "DRESSING", 0.75)
db.insert_record("BK003", "bkfast", "Muffin", "MUFFIN", 2.75)
db.insert_record("HB003", "bev_hot", "Coffee", "COFFEE", 1.99)
db.insert_record("CB003", "bev_cold", "Aquafina", "AQUA H20", 1.05)
db.insert_record("DE003", "deli", "Noodle Cup", "NOODLE CUP", 1.82)
db.insert_record("SN003", "snack", "House Cookie", "HOUSE COOKIE", 1.64)
db.insert_record("CD003", "condiment", "Dressing", "DRESSING", 0.75)
